  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd("LspAttach", {
      ...
      callback = function(ev)
        ...
        keymap.set("n", "<leader>dd", "<cmd>Telescope lsp_definitions<CR>", opts) -- show lsp definitions
    ...
    -- Set default capabilities for all LSP servers (Neovim 0.11 API)
    vim.lsp.config("*", {
